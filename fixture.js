...
const run = async () => {
  ...
  const place = await Place.create(
    ...
    },
    {
      ...
      extraDescription: "В отеле «Ак-Кеме» можно поиграть в настольный теннис и взять напрокат велосипед или автомобиль.",
    },
    {
    ...
    category: categoryPlace[0].id,
      ...
      extraDescription: "Высококвалифицированные, предупредительные и доброжелательные сотрудники отеля всегда к Вашим услугам и рады обеспечить Вам комфорт и удобство на все время Вашего пребывания в нашем Отеле.",
    },
    {
    category: categoryPlace[0].id,
      user: users[0].id,
      ...
      extraDescription: "Отель Каприз-Каракол – это горнолыжный отель расположенный на территории горнолыжной базы Каракол в 7 км от г. Каракол. Отель работает круглый год.",
      },
      {
     category: categoryPlace[0].id,
      user: users[0].id,
